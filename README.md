...
We call _Bessel Function of the first kind_ one of the solutions to this equation, the term “first kind” reflects the fact that the Bessel function includes the functions that, for nonnegative integer ν, are regular at x D 0.
